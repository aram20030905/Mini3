        ...
        <div className="product">
            {state.currentProduct ? (
                <form onSubmit={updateProduct} className="admin">
                    ...
                    <button type="submit">Թարմացնել ապրանքը</button>
                </form>
            ) : (
                <form onSubmit={send} className="admin">
                    <h2>Ավելացնել նոր ապրանք</h2>
                    ...
                    <tbody>
                        {state.productData.map(el => (
                            <tr key={el.id} className="data">
                                ...
                                <td>
                                    <button onClick={() => handleDelete(el.id)}>Ջնջել</button>
                                    <button onClick={() => handleUpdate(el.id)}>Թարմացնել</button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
